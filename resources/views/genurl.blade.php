    ...
    <div class="modal-dialog">
        ...
        <div id="myModal-modal-content" class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="genurlFrm" name="genurlFrm" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="original_url">Original URL</label>
                        <input id="original_url" name="original_url" type="url" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <input id="count" name="count" type="number" class="form-control" value="5" max="50" min="1"
